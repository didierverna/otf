;;; version.lisp --- OTF version management
...
(in-package :net.didierverna.otf.setup)
(in-readtable :net.didierverna.otf)



;; Copyright years
(defvar *copyright-years* "2023, 2026"
...
(defparameter *release-status* :alpha
  "The status of this release.")

(defparameter *release-status-level* 0
  "The status level of this release.")

(defparameter *release-name* "QT Artiston"
  "The name of this release.
The general naming theme for OTF is \"Calligraphical and Handwritten Fonts\",
from the LaTeX Font Catalogue
(https://www.tug.org/FontCatalogue/uncialfonts.html).")
...
(defun version (&optional (type :number))
  "Return the current version of OTF.
...
1.3 {alpha,beta,release candidate,patchlevel} 4 \"QT Artiston\".
