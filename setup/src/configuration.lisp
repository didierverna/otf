;;; configuration.lisp --- OTF configuration management
...
(defvar *configuration* nil
  "The OTF configuration settings.
...
(defun configuration (key)
  "Return KEY's value in the current OTF configuration."
  (getf *configuration* key))

(defun configure (key value)
  "Set KEY to VALUE in the current OTF configuration."
